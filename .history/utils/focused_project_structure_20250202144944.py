...
def process_directory(root_dir, focus_list, indent="", json_structure):
    ...
    for item in sorted(os.listdir(root_dir)):
        ...
        if relative_path in focus_list:
            ...
            if os.path.isdir(path):
                process_directory(path, focus_list, indent + "  ", json_structure)  # Recursively process subdirectory
            else:
