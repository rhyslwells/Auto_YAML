...
def mock_dependencies():
    ...
    with patch("scripts.file_utils.load_file_content", return_value="mock file content") as mock_load_file_content, \
         patch("scripts.file_utils.extract_yaml_header", return_value=({}, "mock body")) as mock_extract_yaml_header, \
         patch("scripts.tagging.generate_yaml_header", return_value={"tags": ["AI", "ML"]}) as mock_generate_yaml_header, \
         patch("scripts.tagging.identify_new_tags", return_value={"ML"}) as mock_identify_new_tags, \
         patch("scripts.file_utils.write_updated_file") as mock_write_updated_file, \
