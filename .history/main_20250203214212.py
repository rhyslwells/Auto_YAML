...
LOG_FILE = os.path.join(LOGS_DIR, "process_log.txt")  # Logs are saved here
NEW_TAGS_LOG = os.path.join(LOGS_DIR, "new_tags_log.txt")  # Logs are saved here

# Configure logging to write to the logs_dir folder
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
def main():
    ...
    try:
        ...
        process_folder(NOTES_DIR, reference_content, prompt_template, reference_tags, args.force, LOG_FILE, NEW_TAGS_LOG)
